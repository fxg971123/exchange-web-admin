<template>
 <div>
    ...
    <Card>
      ...
      <Row class="functionWrapper" style='padding:0px 8px 8px 8px'>
        <Col span="18">
          <div class="searchWrapper" style="float:left;">
              <div class="poptip">
                  <Input placeholder="币种名称" v-model="searchSymbol" />
              </div>
              <div class="poptip">/</div>
              <div class="poptip">
                  <Input placeholder="基础币种名" v-model="searchBase" />
              </div>
              <div class="btns">
      ...
      <hr>
      <p style="font-size:11px;">外部交易所行情获取：http://api.dev.huidu.org/ermarket/thumb/btcusdt</p>
      <p style="font-size:11px;">获取所有机器人配置：http://api.dev.huidu.org/ernormal/robotList</p>
      <Modal
        v-model="ifDelete"
        title="删除交易对"
        @on-ok="confirmDel"
