        ...
        <Col span="24">
          <div class="searchWrapper" style="float:left;">
              ...
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="用户ID" v-model="searchForm.memberId" />
              </div>
              <div class="poptip">
                  <Input placeholder="用户手机号" v-model="searchForm.phone" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="用户邮箱" v-model="searchForm.email" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="可用余额大于" v-model="searchForm.usdtBalance" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="冻结余额大于" v-model="searchForm.usdtFrozenBalance" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="多单杠杆大于" v-model="searchForm.usdtBuyLeverage" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="多单仓位大于" v-model="searchForm.usdtBuyPosition" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="冻结多仓大于" v-model="searchForm.usdtFrozenBuyPosition" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="多单保证金大于" v-model="searchForm.usdtBuyPrincipalAmount" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="空单杠杆大于" v-model="searchForm.usdtSellLeverage" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="空单仓位大于" v-model="searchForm.usdtSellPosition" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="冻结空仓大于" v-model="searchForm.usdtFrozenSellPosition" />
              </div>
              <div class="poptip" style="margin-left: 15px;">
                  <Input placeholder="空单保证金大于" v-model="searchForm.usdtSellPrincipalAmount" />
              </div>
              <div class="btns">
