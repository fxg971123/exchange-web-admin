...
let findSlideArr = [
    ...
    { id: 232, path: '/option', icon: 'cube', component: Main },
    { id: 242, path: '/swap', icon: 'cube', component: Main },
    ...
    { id: 262, path: 'exchangeDetail', icon: 'document', component: resolve => { require(['@/views/finance/ExchangeDetail.vue'], resolve) } },
    ...
    { id: 233, path: 'optionCoinList', icon: 'document', component: resolve => { require(['@/views/option/OptionCoin.vue'], resolve) }},
    { id: 237, path: 'optionList', icon: 'document', component: resolve => { require(['@/views/option/Option.vue'], resolve) }},
    { id: 238, path: 'optionOrderList', icon: 'document', component: resolve => { require(['@/views/option/OptionOrder.vue'], resolve) }},
    { id: 243, path: 'contractCoinList', icon: 'document', component: resolve => { require(['@/views/swap/SwapCoin.vue'], resolve) }},
    { id: 248, path: 'orderEntrustList', icon: 'document', component: resolve => { require(['@/views/swap/EntrustOrder.vue'], resolve) }},
    { id: 250, path: 'memberContractWalletList', icon: 'document', component: resolve => { require(['@/views/swap/MemberContractWallet.vue'], resolve) }},
    { id: 258, path: 'contractRewardList', icon: 'document', component: resolve => { require(['@/views/swap/ContractRewards.vue'], resolve) }},
