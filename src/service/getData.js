...
export const queryContractCoinList = data => post('admin/swap-coin/page-query', data);

//POST获取 "永续合约"=>"交易对管理"=>"新增交易对"
export const addContractCoin = data => post('admin/swap-coin/add', data);

//POST获取 "永续合约"=>"交易对管理"=>"更新交易对"
export const alterContractCoin = data => post('admin/swap-coin/alter', data);

//POST获取 "永续合约"=>"交易对管理"=>"添加用户合约钱包"
export const initContractWallet = data => post('admin/swap-coin/init-wallet', data);

//POST获取 "永续合约"=>"委托管理"=>"查询委托"
export const queryEntrustList = data => post('admin/swap/order/page-query', data);

//POST获取 "永续合约"=>"委托管理"=>"撤销委托"
export const cancelEntrustOrder = data => post('admin/swap/order/cancel', data);

//POST获取 "永续合约"=>"持仓管理"=>"持仓列表"
export const queryPositionList = data => post('admin/swap/position/page-query', data);
...
//POST获取 "永续合约"=>"交易对管理"=>"戳一下"
export const poke = data => post('admin/swap-coin/poke', data);
//POST获取 "期权合约"=>"合约管理"=>"设置预设价格"
export const setPresetPrice = data => post('admin/option/alter', data);
//POST设置期权合约order "期权合约"=>"订单管理"=>"操作"
export const setOptionOrder = data => post('admin/option/order/setOptionOrder', data);

export const exchangeDetail = data => post('admin/finance/member-transaction/exchangeList', data);

// 创世节点 HCD===================================== 
// GET获取 "创世节点"=>"创世节点升星奖励"
export const queryMemberStarRecord = data => fetch('member/getMemberStarRecord', data)
// GET获取 "创世节点"=>"HCD奖励"
export const queryHdcRecord = data => fetch('member/getHdcRecord', data);
// GET获取 "创世节点"=>"创世节点购买记录"
export const queryMemberRecord = data => fetch('member/getMemberRecord', data)
// GET获取 "创世节点"=>"创世节点信息查询"
export const queryHdcInfoRefer = data => fetch('member/getReferre', data)
// GET获取 "创世节点"=>"交易手续费奖励"
